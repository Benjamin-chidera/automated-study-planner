...
export const register = async (
  ...
  try {
    ...
    await createSession(savedUser._id.toString(), savedUser.fullname, savedUser.email, savedUser.image)
...
export const login = async (
  ...
  try {
    ...
    // user is authenticated, create a session for them
    await createSession(user._id.toString(), user.fullname, user.email, user.image)
  } catch (error) {
